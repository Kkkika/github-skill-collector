---
name: digital-brain
description: 当用户要求“写帖子”、“检查链接”、“管理数字任务”或处理一般性的数字助理任务时使用此技能。
  my voice", "look up contact", "prepare for meeting", "weekly review", "track goals",
  or mentions personal brand, content creation, network management, or voice consistency.
repo: muratcankoylan/Agent-Skills-for-Context-Engineering
stars: 8154
raw_url: https://github.com/muratcankoylan/Agent-Skills-for-Context-Engineering/blob/main/examples/digital-brain-skill/SKILL.md
