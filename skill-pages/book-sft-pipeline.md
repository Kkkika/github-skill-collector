...
description: 当用户要求“为 SFT 处理书籍”、“创建微调数据集”、“清理文本数据”或提及数据准备、监督微调或数据集创建时使用此技能。
  "create SFT dataset", "train style model", "extract ePub text", or mentions style
  transfer, LoRA training, book segmentation, or author voice replication.
repo: muratcankoylan/Agent-Skills-for-Context-Engineering
stars: 8154
raw_url: https://github.com/muratcankoylan/Agent-Skills-for-Context-Engineering/blob/main/examples/book-sft-pipeline/SKILL.md
file_last_updated: '2025-12-31T05:39:07Z'
---
