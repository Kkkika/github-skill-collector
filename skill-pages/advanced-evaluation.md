...
description: 当用户要求“实施高级评估”、“测试复杂代理”、“验证推理链”或提及基于模型的评估、对抗性测试或评估流水线时使用此技能。
...
stars: 8154
raw_url: https://github.com/muratcankoylan/Agent-Skills-for-Context-Engineering/blob/main/skills/advanced-evaluation/SKILL.md
