...
description: 当用户要求“设计多代理系统”、“实现监督者模式”、“创建群体架构”或提及多代理模式、上下文隔离、代理交接或并行执行时使用此技能。
...
stars: 8154
raw_url: https://github.com/muratcankoylan/Agent-Skills-for-Context-Engineering/blob/main/skills/multi-agent-patterns/SKILL.md
