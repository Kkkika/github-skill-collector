...
description: 当用户要求“启动 LLM 项目”、“设计批处理流水线”、“评估任务模型匹配度”或提及流水线架构、代理辅助开发、成本估算或项目规划时使用此技能。
...
stars: 8154
raw_url: https://github.com/muratcankoylan/Agent-Skills-for-Context-Engineering/blob/main/skills/project-development/SKILL.md
