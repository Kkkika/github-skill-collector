...
description: 当用户要求“调试代理推理”、“优化思维链”、“分析思考过程”或提及推理痕迹、CoT 优化或调试提示时使用此技能。
  on 'debug agent', 'optimize prompt', 'analyze reasoning', 'why did the agent fail',
  'improve agent performance', or when diagnosing agent failures and context degradation.
repo: muratcankoylan/Agent-Skills-for-Context-Engineering
stars: 8154
raw_url: https://github.com/muratcankoylan/Agent-Skills-for-Context-Engineering/blob/main/examples/interleaved_thinking/SKILL.md
file_last_updated: '2026-01-11T23:42:03Z'
---
