...
description: 用于创建针对 Slack 优化的动画 GIF 的知识和实用工具。提供约束、验证工具和动画概念。当用户请求 Slack 的动画 GIF 时使用，例如"为
  Slack 制作一个 X 做 Y 的 GIF"。
repo: MarcelLeon/skills-zh
stars: 5
raw_url: https://github.com/MarcelLeon/skills-zh/blob/main/skills/slack-gif-creator/SKILL.md
