...
description: 当用户要求“优化上下文”、“减少令牌使用”、“提高提示效率”或提及提示压缩、去除冗余、结构化输入或上下文效率时使用此技能。
...
stars: 8154
raw_url: https://github.com/muratcankoylan/Agent-Skills-for-Context-Engineering/blob/main/skills/context-optimization/SKILL.md
