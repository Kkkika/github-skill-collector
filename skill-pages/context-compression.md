...
description: 当用户要求“压缩上下文”、“总结历史记录”、“减少令牌计数”或处理超出上下文限制的内容、提及上下文蒸馏或信息密度优化时使用此技能。
...
stars: 8154
raw_url: https://github.com/muratcankoylan/Agent-Skills-for-Context-Engineering/blob/main/skills/context-compression/SKILL.md
