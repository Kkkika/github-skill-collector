...
description: 使用现代前端 Web 技术（React、Tailwind CSS、shadcn/ui）创建复杂的、多组件 claude.ai HTML artifacts
  的工具套件。用于需要状态管理、路由或 shadcn/ui 组件的复杂 artifacts - 不适用于简单的单文件 HTML/JSX artifacts。
repo: MarcelLeon/skills-zh
stars: 5
raw_url: https://github.com/MarcelLeon/skills-zh/blob/main/skills/web-artifacts-builder/SKILL.md
file_last_updated: '2026-01-22T15:34:20Z'
---
