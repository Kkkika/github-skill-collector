---
name: hosted-agents
description: 当用户要求“构建后台代理”、“部署托管代理”、“创建服务工作者”或提及服务器端代理、cron 作业、持久化进程或云部署时使用此技能。
  ...
  sandboxes, self-spawning agents, or remote coding environments.
repo: muratcankoylan/Agent-Skills-for-Context-Engineering
stars: 8154
raw_url: https://github.com/muratcankoylan/Agent-Skills-for-Context-Engineering/blob/main/skills/hosted-agents/SKILL.md
