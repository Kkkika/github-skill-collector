---
name: evaluation
description: 当用户要求“评估代理性能”、“创建测试集”、“测量准确性”或提及基准测试、评估指标、测试驱动开发或评估框架时使用此技能。
...
stars: 8154
raw_url: https://github.com/muratcankoylan/Agent-Skills-for-Context-Engineering/blob/main/skills/evaluation/SKILL.md
