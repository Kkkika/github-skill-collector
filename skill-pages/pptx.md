---
name: pptx
description: 演示文稿创建、编辑和分析。当 Claude 需要处理演示文稿（.pptx 文件）时使用，包括：(1) 创建新演示文稿，(2) 修改或编辑内容，(3)
  使用布局，(4) 添加评论或演讲者备注，或任何其他演示文稿任务
repo: MarcelLeon/skills-zh
stars: 5
raw_url: https://github.com/MarcelLeon/skills-zh/blob/main/skills/pptx/SKILL.md
