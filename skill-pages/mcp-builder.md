---
name: mcp-builder
description: 创建高质量 MCP（Model Context Protocol）服务器的指南，使 LLM 能够通过精心设计的工具与外部服务交互。在构建
  MCP 服务器以集成外部 API 或服务时使用，无论是在 Python (FastMCP) 还是 Node/TypeScript (MCP SDK) 中。
repo: MarcelLeon/skills-zh
stars: 5
raw_url: https://github.com/MarcelLeon/skills-zh/blob/main/skills/mcp-builder/SKILL.md
