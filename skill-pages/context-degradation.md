...
description: 当用户要求“诊断上下文问题”、“修复遗忘”、“分析注意力故障”或提及注意力漂移、指令遵循失败、中间丢失效应或上下文过载时使用此技能。
  ...
  or agent performance degradation. Provides patterns for recognizing and mitigating
  context failures.
repo: muratcankoylan/Agent-Skills-for-Context-Engineering
stars: 8154
raw_url: https://github.com/muratcankoylan/Agent-Skills-for-Context-Engineering/blob/main/skills/context-degradation/SKILL.md
