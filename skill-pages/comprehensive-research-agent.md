...
description: 当用户要求“进行深度研究”、“分析多个来源”、“生成研究报告”或提及全面的网络搜索、事实核查或多步骤研究任务时使用此技能。
  in research tasks with multiple tool calls
repo: muratcankoylan/Agent-Skills-for-Context-Engineering
stars: 8154
raw_url: https://github.com/muratcankoylan/Agent-Skills-for-Context-Engineering/blob/main/examples/interleaved_thinking/generated_skills/comprehensive-research-agent/SKILL.md
