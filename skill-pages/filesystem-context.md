...
description: 当用户要求“将上下文卸载到文件”、“创建文件系统记忆”、“管理基于文件的状态”或提及长期存储、文件 I/O 或持久化上下文时使用此技能。
  ...
  agent scratch pads, or just-in-time context loading.
repo: muratcankoylan/Agent-Skills-for-Context-Engineering
stars: 8154
raw_url: https://github.com/muratcankoylan/Agent-Skills-for-Context-Engineering/blob/main/skills/filesystem-context/SKILL.md
file_last_updated: '2026-01-07T08:31:28Z'
---
